<template>
  ...
  <transition appear name="v-img-fade">
    <div v-if="!closed" class="fullscreen-v-img" @click.self="close">
      ...
      <!-- Controls start -->
      <transition appear name="v-img-fade">
        <v-btn icon class="prev-v-img" @click="prev">
          <v-icon large color="white">chevron_left</v-icon>
        </v-btn>
      </transition>
      <transition appear name="v-img-fade">
        <v-btn icon class="next-v-img" @click="next">
          <v-icon large color="white">chevron_right</v-icon>
        </v-btn>
      </transition>
      <!-- Constols end -->
